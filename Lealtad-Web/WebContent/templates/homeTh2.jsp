		...
		<div class="row">
			...
			<div class="col-md-4">
				<p style="padding-left: 30px;">
					<button type="button" class="btn btn-primary btn-lg" style="padding: 10px 70px;cursor: default;background-color: #3f6fb7;">Promocionesen las que participas
			...
			<div class="col-md-4" data-ng-controller="getBalance">
				<p style="padding-left: 30px;">
					<button type="button" class="btn btn-home btn-lg"
						style="padding: 30px 70px; cursor: default;min-width: 450px;background-color: #04a07b;"">
			...
			<div class="col-md-4">
				<p style="padding-left: 30px;">
					<button type="button" ui-sref="account_status" class="btn btn-home btn-lg"
						style="padding: 30px 70px;min-width: 450px;">
	...
	<div>
		...
		<div class="col-md-4" style="margin-left: 25px;">
			<a href="#" data-toggle="modal" data-target="#myModal2"
						...
						<i class="fa fa-question-circle" aria-hidden="true" style="vertical-align: middle; padding-left: -30px;font-size: 30px;"></i>
