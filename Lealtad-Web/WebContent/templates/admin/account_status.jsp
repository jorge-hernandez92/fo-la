	...
	<div class="container" style="width: 1300px;">
		<div class="panel table-top-sivale">
			<div class="panel-heading">
				...
				<div class="navbar container" style="width: 1300px;margin-left: 90px;">
					...
					<div class="navbar-form navbar-left padding-cero" role="search">
						<div class="form-group">
							...
							<label class="checkbox-inline"><input
								ng-click="changeDate(checkboxModel.value)"
								ng-model="checkboxModel.value" type="checkbox" value="">Fecha</label>
						</div>
					</div>
...
<!-- 					<div class="col-md-2"></div> -->
					...
					<div class="col-md-8">
						...
						<button ng-click="getRMPending()" type="button"
						...
						<button ng-click="getRMNoPending()" type="button"
							class="btn btn-primary">
						...
						<button type="button" class="btn btn-primary" ui-sref="home">
