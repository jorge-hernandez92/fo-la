	...
	<div class="navbar container" style="width: 1300px;">
		...
		<div class="navbar-form navbar-left padding-cero" role="search">
			<div class="form-group">
				<input type="text" class="form-control" placeholder="Unidad de Negocio" ng-model="search.campaignName" style="width: 170px;">
				<input type="text" class="form-control" placeholder="Campaña" ng-model="search.classification" style="width: 170px;">
				<input type="text" class="form-control" placeholder="Participante" ng-model="search.classification" style="width: 170px;">
				<input type="text" class="form-control" placeholder="Movimiento" ng-model="search.classification" style="width: 170px;">
				<input type="text" class="form-control" placeholder="Observacio" ng-model="search.classification" style="width: 170px;">
