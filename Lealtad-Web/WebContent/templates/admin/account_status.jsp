...
<!-- 				<input type="text" class="form-control" placeholder="Unidad de Negocio" ng-model="search.unity" style="width: 170px;"> -->
				...
				<label class="checkbox-inline" style="color: white;"><input ng-click="changeDate(checkboxModel.value)" ng-model="checkboxModel.value" type="checkbox" value="">Fecha</label>						
			</div>
		</div>
