		...
		<div class="panel panel-grisT table-top-sivale">
			<div class="panel-heading">
				<div class="container-fluid">
					<div class="navbar-header" style="font-size: 17px;">Datos de Incentivo</div>
				</div>
			</div>
			<div class="panel-body back-sivale">
				...
				<div class="text-right">
					...
					<div class="row margin-top10" data-ng-controller="getCampaignForm">
					...
					<div class="row margin-top10"
						...
						<div class="col-md-5" ng-if="selectCampaign.isNewClass(selectCampaign.items[1])">
					...
					<div class="row margin-top10"
						...
						<div class="col-md-5" ng-if="selectCampaign.isNewClass(selectCampaign.items[2])">
					...
					<div class="row margin-top10"
						...
						<div class="col-md-5" ng-if="selectCampaign.isNewClass(selectCampaign.items[3])">
					...
					<div class="row margin-top10"
						...
						<div class="col-md-5" ng-if="selectCampaign.isNewClass(selectCampaign.items[4])">
					...
					<div class="row margin-top10"
						...
						<div class="col-md-5" ng-if="selectCampaign.isNewClass(selectCampaign.items[5])">
