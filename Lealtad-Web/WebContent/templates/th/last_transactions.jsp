...
<div class="container" style="padding: 0px;">
	...
	<div class="row">
		...
		<div class="col-md-8">
			<h2 class="text-center color-default-ford" style="font-weight: bold;">
				Últimos movimientos de tu tarjeta</h2>
			<br>
		</div>
		<div class="col-md-2"></div>
	</div>
	...
	<section id="transaction">
			...
			<div class="col-md-6">
				<p style="padding-left: 160px;">
					<button type="button" ui-sref="account_status"
						...
						style="padding: 25px 0px; min-width: 450px; font-size: 25px; background-color: #2d96cd; border-color: #2d96cd; color: white;">
			...
			<div class="col-md-5" data-ng-controller="getBalance">
				<p style="padding-left: 70px;">
					<button type="button" class="btn btn-home btn-lg"
						style="padding: 25px 0px; cursor: default; min-width: 450px; font-size: 25px;background-color: #2d96cd; border-color: #2d96cd; color: white;">
		...
		<br>
		<div>
			<div class="container font-color-text" style="width: 1090px;"
				ng-cloak>
