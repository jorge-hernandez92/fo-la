...
<!-- 				<input type="text" class="form-control" placeholder="Unidad de Negocio" ng-model="search.unity" style="width: 170px;"> -->
				...
				<input date-range-picker="" id="daterange1" name="daterange1" class="form-control date-picker ng-pristine ng-valid ng-isolate-scope ng-valid-required ng-touched" type="text" ng-model="date" required="" disabled>
				
				<button class="btn btn-primary" ng-click="searchAccountStatus(date,checkboxModel.value)">Buscar</button>
				
				<label class="checkbox-inline" ><input ng-click="changeDate(checkboxModel.value)" ng-model="checkboxModel.value" type="checkbox" value="">Fecha</label>
