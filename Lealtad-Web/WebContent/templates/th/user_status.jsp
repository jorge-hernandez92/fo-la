...
<div class="container" data-ng-controller="getUserStatus">
<!-- 	<div class="jumbotron"> -->
<!-- 			<div class="row"> -->
...
<!-- 	</div> -->
	...
	<div class="jumbotron" ng-if="userStatus.tjCodigoProcedencia==2">
			<div class="row">
				<div class="col-md-1"></div>
				<div class="col-md-4 text-right">Nombre del Participante:</div>
				<div class="col-md-7">{{userStatus.firstName}} {{userStatus.lastName1}} {{userStatus.lastName1}}</div>
			...
			<div class="row">
				<div class="col-md-1"></div>
				<div class="col-md-4 text-right">STARS:</div>
	...
	<div class="jumbotron" ng-if="userStatus.tjCodigoProcedencia==1">
			<br><br>
			<div class="row">
				<div class="col-md-1"></div>
				<div class="col-md-4 text-right">Nombre del Participante:</div>
		...
		<div class="jumbotron" ng-if="userStatus.tjCodigoProcedencia==3">
			<div class="row">
				<div class="col-md-1"></div>
				<div class="col-md-4 text-right">Nombre del Participante:</div>
				<div class="col-md-7">{{userStatus.firstName}} {{userStatus.lastName1}} {{userStatus.lastName1}}</div>
