			...
			return {
				...
				link: function($scope, $element, $attributes, ngModel) {
					...
					$scope.$watch(function() {						
						$element.data('daterangepicker').startDate = momentify($scope[$attributes.ngModel].startDate);
						$element.data('daterangepicker').endDate = momentify($scope[$attributes.ngModel].endDate);
