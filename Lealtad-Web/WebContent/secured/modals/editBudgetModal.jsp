<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<div class="modal fade" id="modalConfirmEditBudgets" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="bs-example" data-ng-if="myControllerStatus == STATUS_ON_EDIT">
						<br />
						<p><span class="label label-warning">Atención!</span> 
								¿Está seguro que desea guardar los cambios en el presupuesto?</p>
					</div>
				...
				<div class="modal-footer">
					<p class="text-center">
						...
						<a  type="button" class="btn btn-success"
							data-ng-if="myControllerStatus == STATUS_ON_EDIT" 
							data-ng-click="saveBudgets()">
								Guardar
						</a>
