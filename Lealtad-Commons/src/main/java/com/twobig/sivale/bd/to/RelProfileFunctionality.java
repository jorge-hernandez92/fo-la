...
@Entity
@Table(name = "rel_profile_functionality", catalog = "travels_schema")
public class RelProfileFunctionality implements Serializable {
	...
	@Id
	@Column(name = "cat_profile", unique = true, nullable = false)
	private int catProfile;

	@Id
	@Column(name = "cat_functionality", unique = true, nullable = false)
